...
class Model {
    ...
    validate(cb) {
        ...
        if (typeof cb !== 'function') {
            let validated_model = joi.validate(this._object, this.definition.schema, options);
        ...
        joi.validate(this._object, this.definition.schema, options, function (err, validated_model) {
            if (err) {
                return cb(err);
            }
            Object.keys(validated_model).forEach(function (key) {
